...
//   activeCityCords: Coordinates | null; // Allow null for better safety
// };
...
function Mapbox() {
  ...
  const activeCityCords = forecast?.coord; // Ensure this corresponds to your data structure
  
  if (!forecast || !forecast.coord || !activeCityCords) {
    return (
      <div>
        <h1>Loading...</h1>
        {/* Optionally, replace with a spinner or loading animation */}
      </div>
    );
  }

  console.log(activeCityCords);
